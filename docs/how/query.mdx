...
This section details query expressions and their structure. For general information on writing expressions, visit the [Conditions and expressions](./condition.mdx) page. To view an example of a query expression, visit the [Example page](../example.mdx)
...
Wasm queries are used to query information from the Cosmos Wasm module. 
