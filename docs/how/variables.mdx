...
rule for nesting: you can only nested varN with [varN-1, …, var0]

{ vars: [var0, var1, …, varN] } in job - you can only reference/nest previous vars in sequence

update structs/types on Variables