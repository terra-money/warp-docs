...
A condition can either be a combination of conditions or a single expression. This is the "recursive" aspect of conditions, as they can be composed of themselves. Conditions can be nested and chained using regular boolean expressions (and, or, not).
...
Simple values can be strings, integers, 
