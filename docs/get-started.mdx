...
Follow this guide to create an account and start writing jobs and conditions. For more general information on how Warp works, visit the [Overview page](./how/overview.mdx). To learn how to create a template, follow the [template tutorial](./guides/template.mdx). To see an example of a Warp job and condition without a template, visit the [Example page](./guides/example.mdx).
...
3. Deposit some funds into your Warp account to use in jobs or to pay for execution rewards. 

## Create a job using a premade template

[Templates](./guides/template.mdx) help make jobs reusable and easier to create. Use the following steps to create a job from a premade template. 
...
Follow the [template creation guide](./guides/template.mdx) to learn how to make a limit order template. 
