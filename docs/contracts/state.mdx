...
6. If the job's conditions aren't yet met, the job remains in the queue, and it's status is unchanged. If a job fails during execution, its status becomes `Failed`. 
