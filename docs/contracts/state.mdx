...
3. [Owner's can also delete a job while in the _`Pending`_ state. When a job is deleted, its state becomes _`Cancelled`_.](focus://10[17:37],11[17:37],12[36:37],13[36:37],14[36:37],15[32:43],16[32:43],17[32:43])
...
4. If a job has been in the queue too long, Keepers can choose to evict the job from the queue. Evicted jobs become _`Failed`_. 
