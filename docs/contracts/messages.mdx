...
Creates a job using a name, [condition](../how/condition.mdx), execute Wasm message, and a reward. Jobs are stored in an index. Successfully created jobs are given the _`Pending`_ status. 
