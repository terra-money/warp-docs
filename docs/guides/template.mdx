...
1. Open the [Warp app](https://beta.warp.money/) in your browser and connect your wallet. 
...
4. There are two types of templates you can create. Basic templates are used for templating job messages or queries. Advanced templates include conditions, as well as job messages. For this tutorial, select the **Advanced mode**. 

<img className="readme-img-md" src="/img/template/2-new-job.png" />

5. Enter "Swap template" as your template name. For **Template Type**, select **job**. 
...
5. Create another variable with the name _`receive_amount`_. Select **amount** as the **Variable type**. For the **Value,** input _`100`_.
...
In line 27, change _`1000000`_ to _`$warp.variable.send_amount`_.
...
7. Click **Message** and copy and paste the following query message.
